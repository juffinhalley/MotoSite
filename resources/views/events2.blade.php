									...
									<form class="settups-form__form">
										<div class="grid grid--hspace-xl">
											<div class="gcell gcell--md-3">
												<div class="select-wrapper select-wrapper--md select-wrapper--w100 select-wrapper--grey">
													<select class="js-choice-select">
														...
														<option value="2">По нерейтингу</option>
											...
											<div class="gcell gcell--md-6">
												<div class="settups-form__text _jcfe">
													<span class="regular-text regular-text--grey regular-text--t1 _tear">Всего произошло 177 событий</span>
												</div>
											</div>
										</div>
									</form>
									...
									<div class="events-list-item">
										<div class="events-list-item__image-row">
											...
											<div class="place-item__rating">
												...
												<div class="pace-item__rating-count">
													<span>3.8</span>&nbsp;из 5
												</div>
											</div>
