			...
			<div class="page-content">
				<div class="event-create">
					...
					<div class="event-create__wrapper">
						...
						<div class="event-create__downloaded">
							@foreach ($coverItem as $item)
						...
						<div class="event-create__new-textarea">
							...
							<div class="event-create__textarea-delete">
						...
						<div class="event-create__slider">
							<div class="event-create__slider-content">
								@foreach ($sliderItem as $item)
									<div class="event-create__slider-item">
									@include('block.dlPhotoItem')
									</div>
								@endforeach
							</div>
						<div class="event-create__slider-decore">
							<div class="event-create__slider-label">
								<span>
									Слайдер
								</span>
								<a href="#">
					...
					<div class="event-create__textarea">
						<textarea data-rule-minlength="5" data-rule-maxLength="120" name="event-create-textarea" id="event-create-textarea" class="form-textarea" rows="4"></textarea>
					</div>

					<div class="event-create__download _mb-xl">
						@include('block.dlPhotoItem', ['download' => ''])
					</div>
