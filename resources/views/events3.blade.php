					...
					<div class="inner-event__tabs inner-event__tabs--omg">
						...
						<div class="inner-event__tabs-content">
							<div class="inner-event__tab">
								<div class="settups-form settups-form--grey2 _nomg">
										...
										<div class="grid grid--hspace-xl">
											...
											<div class="gcell gcell--md-6">
												<div class="settups-form__text">
													<span class="regular-text regular-text--grey regular-text--t1">Ожидают подтверждения 9 событий</span>
												</div>
											</div>
								...
								<div class="settups-disclaimer _mgb30">
									Событие будет отображаться в списке актуальных и учитываться в рейтингах после того как его подтвердили 15 пользователей
								</div>
							</div>
								...
								@for ($i = 0; $i < 4; $i++)
									<div class="events-list-item">
										<div class="events-list-item__image-row">
											...
											<div class="events-list-item__confirm">
												<div class="events-list-item__confirm-text">
													Подтвердить
												</div>
											</div>
