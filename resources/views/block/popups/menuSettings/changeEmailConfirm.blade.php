	...
	<form class="js-form popup-form popup-form--ms" method="post" data-ajax="./hidden/response/demo.json">
		...
		<div class="grid grid--1">
			...
			<div class="gcell _flex _justify-center _mb-lg _text-center">
				<span class="title title--dark title--light title--ms">Для подтверждения нового e-mail введите код, присланный на почту</span>
			</div>

			<div class="gcell _mb-mg">
				<div class="form-item">
					<label class="form-caption" for="code-email-confirm">
						Введите код
					</label>
					<input required type="text" data-rule-minLength="5" data-rule-maxLength="12" class="form-input form-input--type2" name="code-email-confirm" id="code-email-confirm" value="">
				</div>
			</div>
